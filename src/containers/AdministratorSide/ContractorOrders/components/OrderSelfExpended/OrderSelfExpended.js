...
import styles from "./OrderSelfExpended.module.css";

const OrderSelfExpended = ({ order, ActionButtons }) => {
  const { product, count, totalPrice, cityName, fullName, postOfficeName } = order;
...
export default OrderSelfExpended;
